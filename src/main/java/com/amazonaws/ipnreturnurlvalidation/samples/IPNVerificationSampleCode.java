...
public class IPNVerificationSampleCode {
    ...
    public static void main(String... args) throws Exception {
        ...
        String urlEndPoint = "http://www.mysite.com/ipn.jsp"; // Your url end
                                                              // point receiving
                                                              // the ipn.
        System.out.println("Verifying IPN signed using signature v2 ....");
        // IPN is sent as a http POST request and hence we specify POST as the
        // http method.
        // Signature verification does not require your secret key
        System.out.println("Is signature correct: "
                + (new SignatureUtilsForOutbound()).validateRequest(params, urlEndPoint, "POST"));
    }
}
