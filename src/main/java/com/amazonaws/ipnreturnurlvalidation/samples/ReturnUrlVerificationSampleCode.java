...
public class ReturnUrlVerificationSampleCode {
    ...
    public static void main(String... args) throws Exception {
        ...
        String urlEndPoint = "http://www.mysite.com/call_pay.jsp"; // Your
                                                                   // return url
                                                                   // end point.
        System.out.println("Verifying return url signed using signature v2 ....");
        // return url is sent as a http GET request and hence we specify GET as
        // the http method.
        // Signature verification does not require your secret key
        System.out.println("Is signature correct: "
                + (new SignatureUtilsForOutbound()).validateRequest(params, urlEndPoint, "GET"));
    }
}
