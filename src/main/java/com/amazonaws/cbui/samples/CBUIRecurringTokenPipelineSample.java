...
public class CBUIRecurringTokenPipelineSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        pipeline.setMandatoryParameters("callerReferenceRecurring", "http://www.mysite.com/call_back.jsp", "5",
                "1 Month");

        // optional parameters
        pipeline.addParameter("paymentMethod", "CC"); // accept only credit card
                                                      // payments
