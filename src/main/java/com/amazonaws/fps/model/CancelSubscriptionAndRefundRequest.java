...
@XmlType(name = "", propOrder = { "subscriptionId", "refundAmount", "callerReference", "cancelReason" })
...
public class CancelSubscriptionAndRefundRequest {
     ...
     * 
     */
    public CancelSubscriptionAndRefundRequest(final String subscriptionId, final Amount refundAmount,
            final String callerReference, final String cancelReason) {
