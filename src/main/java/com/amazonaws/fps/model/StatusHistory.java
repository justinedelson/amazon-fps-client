...
@XmlType(name = "StatusHistory", propOrder = { "date", "transactionStatus", "statusCode", "amount" })
public class StatusHistory {
     ...
     * 
     */
    public StatusHistory(final XMLGregorianCalendar date, final TransactionStatus transactionStatus,
            final String statusCode, final Amount amount) {
        this.date = date;
