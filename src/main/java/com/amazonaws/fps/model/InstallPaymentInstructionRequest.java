...
@XmlType(name = "", propOrder = { "paymentInstruction", "tokenFriendlyName", "callerReference", "tokenType",
        "paymentReason" })
...
public class InstallPaymentInstructionRequest {
     ...
     * 
     */
    public InstallPaymentInstructionRequest(final String paymentInstruction, final String tokenFriendlyName,
            final String callerReference, final TokenType tokenType, final String paymentReason) {
