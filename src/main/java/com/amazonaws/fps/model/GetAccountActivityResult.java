...
@XmlType(name = "", propOrder = { "batchSize", "transaction", "startTimeForNextTransaction" })
...
public class GetAccountActivityResult {
     ...
     * 
     */
    public GetAccountActivityResult(final Integer batchSize, final List<Transaction> transaction,
            final XMLGregorianCalendar startTimeForNextTransaction) {
     ...
     * Sets the value of the transaction property.
     * 
     * @param transaction allowed object is {@link Transaction }
     * 
     */
