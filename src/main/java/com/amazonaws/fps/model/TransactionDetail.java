...
@XmlType(name = "TransactionDetail", propOrder = { "transactionId", "callerReference", "callerDescription",
        "senderDescription", "dateReceived", "dateCompleted", "transactionAmount", "fpsFees", "marketplaceFees",
        "fpsFeesPaidBy", "senderTokenId", "recipientTokenId", "prepaidInstrumentId", "creditInstrumentId",
        "fpsOperation", "paymentMethod", "transactionStatus", "statusCode", "statusMessage", "senderName",
        "senderEmail", "callerName", "recipientName", "recipientEmail", "relatedTransaction", "statusHistory" })
public class TransactionDetail {
     ...
     * 
     */
    public TransactionDetail(final String transactionId, final String callerReference, final String callerDescription,
            final String senderDescription, final XMLGregorianCalendar dateReceived,
            final XMLGregorianCalendar dateCompleted, final Amount transactionAmount, final Amount fpsFees,
            final Amount marketplaceFees, final TransactionalRole fpsFeesPaidBy, final String senderTokenId,
            final String recipientTokenId, final String prepaidInstrumentId, final String creditInstrumentId,
            final FPSOperation fpsOperation, final PaymentMethod paymentMethod,
            final TransactionStatus transactionStatus, final String statusCode, final String statusMessage,
            final String senderName, final String senderEmail, final String callerName, final String recipientName,
            final String recipientEmail, final List<RelatedTransaction> relatedTransaction,
     ...
     * <CODE>set</CODE> method for the relatedTransaction property.
     * 
     * <p>
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the statusHistory property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * Sets the value of the relatedTransaction property.
     * 
     * @param relatedTransaction allowed object is {@link RelatedTransaction }
     * 
     */
     ...
     * Sets the value of the statusHistory property.
     * 
     * @param statusHistory allowed object is {@link StatusHistory }
     * 
     */
    ...
    protected String toJSONFragment() {
        ...
        if (isSetRelatedTransaction()) {
            ...
            for (RelatedTransaction relatedTransaction : relatedTransactionList) {
                if (relatedTransactionListIndex > 0)
                    json.append(", ");
                json.append("{");
                json.append("");
