...
public enum FPSOperation {
    ...
    @XmlEnumValue("Pay")
    PAY("Pay"), @XmlEnumValue("Refund")
    REFUND("Refund"), @XmlEnumValue("Settle")
    SETTLE("Settle"), @XmlEnumValue("SettleDebt")
    SETTLE_DEBT("SettleDebt"), @XmlEnumValue("WriteOffDebt")
    WRITE_OFF_DEBT("WriteOffDebt"), @XmlEnumValue("FundPrepaid")
    FUND_PREPAID("FundPrepaid"), @XmlEnumValue("Reserve")
    RESERVE("Reserve");
