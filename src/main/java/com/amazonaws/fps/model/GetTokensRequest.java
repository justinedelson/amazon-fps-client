...
@XmlType(name = "", propOrder = { "tokenStatus", "tokenType", "callerReference", "tokenFriendlyName" })
...
public class GetTokensRequest {
     ...
     * 
     */
    public GetTokensRequest(final TokenStatus tokenStatus, final TokenType tokenType, final String callerReference,
            final String tokenFriendlyName) {
