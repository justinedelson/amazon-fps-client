...
@XmlType(name = "", propOrder = { "maxBatchSize", "startDate", "endDate", "sortOrderByDate", "fpsOperation",
        "paymentMethod", "role", "transactionStatus" })
...
public class GetAccountActivityRequest {
     ...
     * 
     */
    public GetAccountActivityRequest(final Integer maxBatchSize, final XMLGregorianCalendar startDate,
            final XMLGregorianCalendar endDate, final SortOrder sortOrderByDate, final FPSOperation fpsOperation,
            final PaymentMethod paymentMethod, final List<TransactionalRole> role,
     ...
     * 
     * @return possible object is {@link SortOrder }
     * 
     */
     ...
     * 
     * @param value allowed object is {@link SortOrder }
     * 
     */
     ...
     * Sets the value of the role property.
     * 
     * @param role allowed object is {@link TransactionalRole }
     * 
     */
