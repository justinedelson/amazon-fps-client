...
@XmlType(name = "Token", propOrder = { "tokenId", "friendlyName", "tokenStatus", "dateInstalled", "callerReference",
        "tokenType", "oldTokenId", "paymentReason" })
public class Token {
     ...
     * 
     */
    public Token(final String tokenId, final String friendlyName, final TokenStatus tokenStatus,
            final XMLGregorianCalendar dateInstalled, final String callerReference, final TokenType tokenType,
            final String oldTokenId, final String paymentReason) {
     ...
     * 
     * @return possible object is {@link TokenStatus }
     * 
     */
     ...
     * 
     * @param value allowed object is {@link TokenStatus }
     * 
     */
