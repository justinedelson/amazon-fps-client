...
@XmlType(name = "", propOrder = { "token", "paymentInstruction", "callerReference", "tokenFriendlyName" })
...
public class GetPaymentInstructionResult {
     ...
     * 
     */
    public GetPaymentInstructionResult(final Token token, final String paymentInstruction,
            final String callerReference, final String tokenFriendlyName) {
        this.token = token;
     ...
     * 
     * @param value allowed object is {@link Token }
     * 
     */
