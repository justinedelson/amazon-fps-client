...
/**
 * <p>
 * Java class for TokenUsageLimit complex type.
 * 
 * <p>
...
@XmlType(name = "TokenUsageLimit", propOrder = { "count", "amount", "lastResetCount", "lastResetAmount",
        "lastResetTimestamp" })
public class TokenUsageLimit {
     ...
     * 
     */
    public TokenUsageLimit(final Integer count, final Amount amount, final Integer lastResetCount,
            final Amount lastResetAmount, final XMLGregorianCalendar lastResetTimestamp) {
        this.count = count;
        this.amount = amount;
