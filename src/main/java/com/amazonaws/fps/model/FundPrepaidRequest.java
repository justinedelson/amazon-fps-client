...
@XmlType(name = "", propOrder = { "senderTokenId", "prepaidInstrumentId", "fundingAmount", "callerReference",
...
public class FundPrepaidRequest {
     ...
     * 
     */
    public FundPrepaidRequest(final String senderTokenId, final String prepaidInstrumentId, final Amount fundingAmount,
            final String callerReference, final String senderDescription, final String callerDescription,
            final DescriptorPolicy descriptorPolicy, final Integer transactionTimeoutInMins) {
