...
/**
 * <p>
 * Java class for MarketplaceRefundPolicy.
 * 
 * <p>
...
public enum MarketplaceRefundPolicy {
    ...
    MASTER_TXN_ONLY("MasterTxnOnly"), @XmlEnumValue("MarketplaceTxnOnly")
    MARKETPLACE_TXN_ONLY("MarketplaceTxnOnly"), @XmlEnumValue("MasterAndMarketplaceTxn")
