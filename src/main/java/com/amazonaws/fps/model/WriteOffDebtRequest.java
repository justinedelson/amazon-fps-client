...
@XmlType(name = "", propOrder = { "creditInstrumentId", "adjustmentAmount", "callerReference", "callerDescription" })
...
public class WriteOffDebtRequest {
     ...
     * 
     */
    public WriteOffDebtRequest(final String creditInstrumentId, final Amount adjustmentAmount,
            final String callerReference, final String callerDescription) {
