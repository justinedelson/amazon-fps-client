...
@XmlType(name = "", propOrder = { "transactionId", "transactionStatus", "callerReference", "statusCode",
        "statusMessage" })
...
public class GetTransactionStatusResult {
     ...
     * 
     */
    public GetTransactionStatusResult(final String transactionId, final TransactionStatus transactionStatus,
            final String callerReference, final String statusCode, final String statusMessage) {
