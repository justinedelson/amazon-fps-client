...
public class CancelSubscriptionAndRefundSample {
    ...
    /**
     * Just add few required parameters, and try the service Cancel Subscription
     ...
     */
    public static void invokeCancelSubscriptionAndRefund(AmazonFPS service,
            CancelSubscriptionAndRefundRequest fpsRequest) {
        try {
            ...
            if (fpsResponse.isSetCancelSubscriptionAndRefundResult()) {
                ...
                System.out.println();
                CancelSubscriptionAndRefundResult cancelSubscriptionAndRefundResult = fpsResponse
                        .getCancelSubscriptionAndRefundResult();
