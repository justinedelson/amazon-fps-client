...
public class InstallPaymentInstructionAsyncSample {
    ...
    /**
     * Just add few required parameters, and try the service Install Payment
    ...
    /**
     * Install Payment Instruction request sample Installs a payment instruction
     * for caller.
     * 
     * @param service instance of AmazonFPS service
     * @param requests list of requests to process
     */
    public static void invokeInstallPaymentInstruction(AmazonFPSAsync service,
            List<InstallPaymentInstructionRequest> requests) {
