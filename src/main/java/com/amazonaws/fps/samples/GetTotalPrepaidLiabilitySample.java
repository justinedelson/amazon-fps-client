...
public class GetTotalPrepaidLiabilitySample {
    ...
    /**
     * Just add few required parameters, and try the service Get Total Prepaid
     * Liability functionality
     * 
     * @param args unused
     */
    ...
    public static void invokeGetTotalPrepaidLiability(AmazonFPS service, GetTotalPrepaidLiabilityRequest fpsRequest) {
        try {
            ...
            if (fpsResponse.isSetGetTotalPrepaidLiabilityResult()) {
                ...
                System.out.println();
                GetTotalPrepaidLiabilityResult getTotalPrepaidLiabilityResult = fpsResponse
                        .getGetTotalPrepaidLiabilityResult();
                if (getTotalPrepaidLiabilityResult.isSetOutstandingPrepaidLiability()) {
                    System.out.println("            OutstandingPrepaidLiability");
                    System.out.println();
                    OutstandingPrepaidLiability outstandingPrepaidLiability = getTotalPrepaidLiabilityResult
