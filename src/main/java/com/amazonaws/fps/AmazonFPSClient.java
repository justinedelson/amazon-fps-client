 ...
 * 
 * 
 * AmazonFPSClient is implementation of AmazonFPS based on the Apache <a
...
public class AmazonFPSClient implements AmazonFPS {
    ...
    private static Pattern ERROR_PATTERN_TWO = Pattern.compile(".*\\<Error>\\<Code>(.*)\\</Code>\\<Message>(.*)"
            + "\\</Message>\\</Error>.*(\\<Error>)?.*\\<RequestID>(.*)\\</RequestID>.*", Pattern.MULTILINE
            | Pattern.DOTALL);
    ...
    /**
     * Constructs AmazonFPSClient with AWS Access Key ID, AWS Secret Key and
     * AmazonFPSConfig. Use AmazonFPSConfig to pass additional configuration
     * that affects how service is being called.
     * 
     * @param awsAccessKeyId AWS Access Key ID
     * @param awsSecretAccessKey AWS Secret Access Key
     ...
     * account.
     * 
     * @param request CancelTokenRequest request
     * @return CancelToken Response from the service
     * 
     ...
     * 
     * @param request CancelRequest request
     * @return Cancel Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request FundPrepaidRequest request
     * @return FundPrepaid Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request GetAccountActivityRequest request
     * @return GetAccountActivity Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request GetAccountBalanceRequest request
     * @return GetAccountBalance Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request GetDebtBalanceRequest request
     * @return GetDebtBalance Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request GetOutstandingDebtBalanceRequest request
     * @return GetOutstandingDebtBalance Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request GetPrepaidBalanceRequest request
     * @return GetPrepaidBalance Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request GetTokenByCallerRequest request
     * @return GetTokenByCaller Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request CancelSubscriptionAndRefundRequest request
     * @return CancelSubscriptionAndRefund Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request GetTokenUsageRequest request
     * @return GetTokenUsage Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request GetTokensRequest request
     * @return GetTokens Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request GetTotalPrepaidLiabilityRequest request
     * @return GetTotalPrepaidLiability Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request GetTransactionRequest request
     * @return GetTransaction Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request GetTransactionStatusRequest request
     * @return GetTransactionStatus Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request GetPaymentInstructionRequest request
     * @return GetPaymentInstruction Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request InstallPaymentInstructionRequest request
     * @return InstallPaymentInstruction Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request PayRequest request
     * @return Pay Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request RefundRequest request
     * @return Refund Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * 
     * Reserve API is part of the Reserve and Settle API conjunction that serve
     * the purpose of a pay where the authorization and settlement have a timing
     * difference.
     * 
     * @param request ReserveRequest request
     * @return Reserve Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request SettleRequest request
     * @return Settle Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * 
     * Allows a caller to initiate a transaction that atomically transfers money
     * from a sender’s payment instrument to the recipient, while decreasing
     * corresponding debt balance.
     * 
     * @param request SettleDebtRequest request
     * @return SettleDebt Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * 
     * Allows a creditor to write off the debt balance accumulated partially or
     * fully at any time.
     * 
     * @param request WriteOffDebtRequest request
     * @return WriteOffDebt Response from the service
     * 
     * @throws AmazonFPSException
     */
     ...
     * 
     * @param request VerifySignatureRequest request
     * @return VerifySignature Response from the service
     * 
     * @throws AmazonFPSException
     */
    ...
    private HttpClient configureHttpClient() {
        ...
        if (config.isSetProxyHost() && config.isSetProxyPort()) {
            log
                    .info("Configuring Proxy. Proxy Host: " + config.getProxyHost() + "Proxy Port: "
                            + config.getProxyPort());
    ...
    private <T> T invoke(Class<T> clazz, Map<String, String> parameters) throws AmazonFPSException {
        ...
        try {
            ...
            method.addRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset="
                    + DEFAULT_ENCODING.toLowerCase());
                ...
                try {
                    ...
                    if (status == HttpStatus.SC_OK) {
                        ...
                        if ((status == HttpStatus.SC_INTERNAL_SERVER_ERROR || status == HttpStatus.SC_SERVICE_UNAVAILABLE)
                            ...
                            throw new AmazonFPSException(error.getMessage(), status, error.getCode(), error.getType(),
                                    errorResponse.getRequestId(), errorResponse.toXML());
                        }
                    }
    ...
    private AmazonFPSException processErrors(String responseString, int status) {
        ...
        if (responseString != null && responseString.startsWith("<")) {
            ...
            if (matcher.matches()) {
                ex = new AmazonFPSException(matcher.group(3), status, matcher.group(2), "Unknown", matcher.group(1),
                        responseString);
            } else {
                matcher = ERROR_PATTERN_TWO.matcher(responseString);
                if (matcher.matches()) {
                    ex = new AmazonFPSException(matcher.group(2), status, matcher.group(1), "Unknown",
