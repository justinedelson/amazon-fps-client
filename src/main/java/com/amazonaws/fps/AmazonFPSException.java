...
/**
 * Amazon FPS Exception provides details of errors returned by Amazon FPS
 * service
 * 
 */
public class AmazonFPSException extends Exception {
     ...
     * 
     * @param message Overview of error
     */
     ...
     * 
     * @param message Overview of error
     * @param statusCode HTTP status code for error response
     */
     ...
     * @param errorType Error type. Possible types: Sender, Receiver or Unknown
     * @param requestId Request ID returned by the service
     * @param xml Compete xml found in response
     */
    public AmazonFPSException(String message, int statusCode, String errorCode, String errorType, String requestId,
            String xml) {
