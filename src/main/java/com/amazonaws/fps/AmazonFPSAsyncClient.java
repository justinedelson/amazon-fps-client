...
public class AmazonFPSAsyncClient extends AmazonFPSClient implements AmazonFPSAsync {
     ...
     * http connections specified in AmazonFPSConfig. Default number of max http
     * connections is 100.
     * 
     ...
     * 
     */
    public AmazonFPSAsyncClient(String awsAccessKeyId, String awsSecretAccessKey, AmazonFPSConfig config,
     ...
     * @return Future&lt;CancelTokenResponse&gt; future pointer to
     *         CancelTokenResponse
     * 
     */
     ...
     * @return Future&lt;FundPrepaidResponse&gt; future pointer to
     *         FundPrepaidResponse
     * 
     */
     ...
     * @return Future&lt;GetAccountActivityResponse&gt; future pointer to
     *         GetAccountActivityResponse
     * 
     */
     ...
     * @return Future&lt;GetAccountBalanceResponse&gt; future pointer to
     *         GetAccountBalanceResponse
     * 
     */
     ...
     * @return Future&lt;GetDebtBalanceResponse&gt; future pointer to
     *         GetDebtBalanceResponse
     * 
     */
     ...
     * @return Future&lt;GetOutstandingDebtBalanceResponse&gt; future pointer to
     *         GetOutstandingDebtBalanceResponse
     * 
     */
    public Future<GetOutstandingDebtBalanceResponse> getOutstandingDebtBalanceAsync(
            final GetOutstandingDebtBalanceRequest request) {
        Future<GetOutstandingDebtBalanceResponse> response = executor
                .submit(new Callable<GetOutstandingDebtBalanceResponse>() {
     ...
     * @return Future&lt;GetPrepaidBalanceResponse&gt; future pointer to
     *         GetPrepaidBalanceResponse
     * 
     */
     ...
     * @return Future&lt;GetTokenByCallerResponse&gt; future pointer to
     *         GetTokenByCallerResponse
     * 
     */
     ...
     * @return Future&lt;CancelSubscriptionAndRefundResponse&gt; future pointer
     *         to CancelSubscriptionAndRefundResponse
     * 
     */
    public Future<CancelSubscriptionAndRefundResponse> cancelSubscriptionAndRefundAsync(
            final CancelSubscriptionAndRefundRequest request) {
        Future<CancelSubscriptionAndRefundResponse> response = executor
                .submit(new Callable<CancelSubscriptionAndRefundResponse>() {
     ...
     * @return Future&lt;GetTokenUsageResponse&gt; future pointer to
     *         GetTokenUsageResponse
     * 
     */
     ...
     * @return Future&lt;GetTokensResponse&gt; future pointer to
     *         GetTokensResponse
     * 
     */
     ...
     * @return Future&lt;GetTotalPrepaidLiabilityResponse&gt; future pointer to
     *         GetTotalPrepaidLiabilityResponse
     * 
     */
    public Future<GetTotalPrepaidLiabilityResponse> getTotalPrepaidLiabilityAsync(
            final GetTotalPrepaidLiabilityRequest request) {
        Future<GetTotalPrepaidLiabilityResponse> response = executor
                .submit(new Callable<GetTotalPrepaidLiabilityResponse>() {
     ...
     * @return Future&lt;GetTransactionResponse&gt; future pointer to
     *         GetTransactionResponse
     * 
     */
     ...
     * @return Future&lt;GetTransactionStatusResponse&gt; future pointer to
     *         GetTransactionStatusResponse
     * 
     */
     ...
     * @return Future&lt;GetPaymentInstructionResponse&gt; future pointer to
     *         GetPaymentInstructionResponse
     * 
     */
     ...
     * @return Future&lt;InstallPaymentInstructionResponse&gt; future pointer to
     *         InstallPaymentInstructionResponse
     * 
     */
    public Future<InstallPaymentInstructionResponse> installPaymentInstructionAsync(
            final InstallPaymentInstructionRequest request) {
        Future<InstallPaymentInstructionResponse> response = executor
                .submit(new Callable<InstallPaymentInstructionResponse>() {
     ...
     * @return Future&lt;SettleDebtResponse&gt; future pointer to
     *         SettleDebtResponse
     * 
     */
     ...
     * @return Future&lt;WriteOffDebtResponse&gt; future pointer to
     *         WriteOffDebtResponse
     * 
     */
     ...
     * @return Future&lt;VerifySignatureResponse&gt; future pointer to
     *         VerifySignatureResponse
     * 
     */
